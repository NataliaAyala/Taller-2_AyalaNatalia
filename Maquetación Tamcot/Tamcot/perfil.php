    ...
    <div class="navbar navbar-default navbar-fixed-top">
      <div class="container">
       ...
       <a href="perfil.php">Usuario</a>
            ...
            <button type="button" class="btn btn-default btn-sm sesion">
...
<div class="fondoContactoVerde">

  <div class = "contactoBanner">
     <a href="#Banner">
       <img src="images/contactobanner.png">
    </a>
    <div class="bannertitulo">
         <p>VideoGamerr77</p></div>
         <div class="bannertxt">
         <p>usuario</p>/</div>
  </div> 
</div>
...
<!-- GrupoDeTrabajo -->
  ...
  <div id= "seccionVideojuegos">
   <div class="container">
      <!-- INTEGRANTES -->
      <div class="row">
        <div class="col-xs-1 videojuegosIcono">
          <img src="images/Noticias.png" width="60">
        </div>
        <div class="col-xs-11">
          <h2>Tus compras</h2> 
        </div>
