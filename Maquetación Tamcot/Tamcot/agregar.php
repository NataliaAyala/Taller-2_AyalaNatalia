<?php
 ...
 //Sacado de http://www.programacionweb.net/articulos/articulo/carro-de-compras-en-php/
...
conectarse(); //Conectar la base de datos
...
header("Location:videojuegos.php?".SID); 
?> 