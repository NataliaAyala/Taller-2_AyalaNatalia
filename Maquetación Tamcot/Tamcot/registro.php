...
<div class="row">
    ...
    <input type="text" class="form-control inputfiltro datosUsuario" required placeholder="usuario" >
    </input>
    <input type="text" class="form-control inputfiltro datosUsuario" required placeholder="correo">
    </input>

 <input type="text" class="form-control inputfiltro datosUsuario" required placeholder="password">
    </input>

    <input type="text" class="form-control inputfiltro datosUsuario" required placeholder="repite password">
    </input>
